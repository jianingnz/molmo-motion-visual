...
Combined successor to `motion-teaser-viz` (non-DROID-heavy) and
`motion-teaser-viz2` (DROID-heavy): keeps the complete non-DROID example set
from viz1 and the complete DROID example set from viz2 in a single repo.
